...
namespace Editor.ImpostorGeneration.AmplifyImpostors.Scripts
{
	public class Preferences
	{
		...
		public static void PreferencesGUI()
		{
			...
			GlobalSpecularSmoothness = EditorGUILayout.TextField( "AO & Roughness", GlobalSpecularSmoothness );
		...
		public static void LoadDefaults()
		{
			...
			GlobalAlbedoAlpha = EditorPrefs.GetString( PrefGlobalGBuffer0Name, "_CA" );
			GlobalSpecularSmoothness = EditorPrefs.GetString( PrefGlobalGBuffer1Name, "_ORM" );
			GlobalNormalDepth = EditorPrefs.GetString( PrefGlobalGBuffer2Name, "_ND" );
