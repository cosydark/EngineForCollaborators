...
namespace Editor.ImpostorGeneration.AmplifyImpostors.Editor.ShaderEditorNode
{
	...
	public sealed class AmplifyImpostorNode : ParentNode
	{
		...
		public override string GenerateShaderForOutput( int outputId, ref MasterNodeDataCollector dataCollector, bool ignoreLocalvar )
		{
			...
			bool isHDRP = ( dataCollector.IsSRP && dataCollector.CurrentSRPType == AmplifyShaderEditor.TemplateSRPType.HD );
		...
		public override void WriteToString( ref string nodeInfo, ref string connectionsInfo )
		{
			...
			IOUtils.AddFieldValueToString( ref nodeInfo, Scripts.VersionInfo.FullNumber );
		...
		public override void ReadFromString( ref string[] nodeParams )
		{
			...
			int version = 0;
			if( UIUtils.CurrentShaderVersion() > 15602 && Scripts.VersionInfo.FullNumber >= 9202 )
		...
		void GenerateImpostorFragment( ref MasterNodeDataCollector dataCollector, bool withSpec = true, bool withEmission = true, bool isSRP = false )
		{
			...
			bool patchDepthOffset = ( !isSRP || (int)ASEPackageManagerHelper.CurrentHDVersion < 140000 );
			if ( patchDepthOffset )
			{
