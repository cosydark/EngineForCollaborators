	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag_surf (v2f_surf IN, out float outDepth : SV_Depth ) : SV_Target {
				...
				return fixed4(o.Albedo, outputAlpha);
			}
		...
		Pass
        {
            ...
            #pragma multi_compile _ XRENDER_INDIRECT_INSTANCING_ON
            #include "Packages/com.funplus.xrender/Shaders/Library/ShaderPassDefine.hlsl"
            #define SHADER_PASS SHADERPASS_DEPTH_NORMAL
            #define DEPTH_NORMAL_PASS_INDEX 0
            #define ENABLE_MOTION_VECTOR_PASS_IN_DEPTH_NORMAL 1
            #include "Packages/com.funplus.xrender/Shaders/ShaderPass/DepthNormalsPass.Header.hlsl"
            #include "Assets/Res/Shader/MaterialModel/MM_EV_FoliageX.Header.hlsl"
            ...
            #include "Assets/Res/Shader/MaterialModel/MM_EV_FoliageX.hlsl"
            #include "Packages/com.funplus.xrender/Shaders/ShaderPass/DepthNormalsPass.hlsl"
            #pragma vertex Vert
